...
export default function CardStackSlider() {
  ...
  return (
    <div className=" lg:mt-[120px] w-full relative  mt-[60px]">
      <Image
        src="/frame.png"
        width={500}
        height={500}
        alt="frame"
        className="lg:block hidden h-[200px] w-[200px] object-center absolute top-[261px] left-[335px] "
      />
         <Image
        src="/frame.png"
        width={500}
        height={500}
        alt="frame"
        className="lg:block hidden h-[200px] w-[200px] object-center absolute top-[62px] right-[177px] "
      />
        ...
        <div className="relative w-full   md:h-[643px] sm:h-[490px] h-[290px] flex sm:items-center sm:justify-center perspective">
          <div className="relative w-full h-full ">
            <Image
              ...
              width={500}
              height={500}
              className="absolute z-10 left-1/2 -translate-x-1/2 top-1/2 lg:block hidden -translate-y-1/2"
            />
